...
//Rotated array meeans initially nums array is sorted in increasing order and than it is rotated about a random pivot k ,we to find the target in this rotated array
#include <bits/stdc++.h>
using namespace std;
